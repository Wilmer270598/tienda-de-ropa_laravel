...
@section('title', 'Agregar Cliente Común')

@section('content')
<h2 class="mb-4" style="color:#fff;">Agregar Cliente Común</h2>
...
<form action="{{ route('clientes_comunes.store') }}" method="POST" style="background-color:#5583ab; padding:20px; border-radius:10px; color:#fff; max-width:600px;">
    @csrf
    ...
    <button type="submit" class="btn" style="background-color:#273e52; color:#fff;">Guardar Cliente Común</button>
</form>
@endsection
